...
import { usuario, consultarDatabaseServiciosUsuario, editarUnServicio, eliminarUnServicio, listaAdmins } from './../config/firebase';
...
export const AjustesUsuario = () => {
    ...
    useEffect(() => {
        ...
        if(listaAdmins.includes(usuario.email)){
            setsuperUser(true)
        }
                ...
                <div className="col-md-6">
                    ...
                    <form>
                        <div className="form " id="htmlmActualizacionDatos">
                            ...
                            <hr/>
                            {superUser &&<Link className="btn btn-outline-primary" to="/GestionDesarrolladores"> Gestionar Desarrolladores</Link>}
