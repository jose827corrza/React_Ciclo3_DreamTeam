...
export const consultarDatabaseServiciosUsuario = async (nombreColeccion, usr) =>{
    try {
...
export const consultarServicioParticularUsuario = async (nombreColeccion, idServicio) => {
    try {
